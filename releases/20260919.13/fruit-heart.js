...
(function () {
  ...
  if (COMMON_JS) {
    ...
    const SCRIPT_VERSION = "20260919.13";
...
/flushvar final_message ||`;
    ...
    const QR_BAR_HOSTS = '#qr--bar > .qr--buttons,#qr--bar .qr--buttons,.qr--buttons,#quickReplies';
