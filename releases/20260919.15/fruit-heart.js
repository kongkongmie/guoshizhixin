...
(function () {
  ...
  if (COMMON_JS) {
    ...
    const SCRIPT_VERSION = "20260919.15";
...
/flushvar final_message ||`;
    ...
    try {
        if (hostWindow.localStorage.getItem(ENTRY_DEFAULTS_KEY) !== '1') {
            hostWindow.localStorage.setItem('fruit-heart-entry-bar', 'true');
            hostWindow.localStorage.setItem('fruit-heart-entry-ball', 'true');
